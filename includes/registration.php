...
$defaultText = "Please complete this registration form to receive a library card. You must provide your first name, last name, and email address.";

$errorText = "I Have A Bad Feeling About This. You're missing something - try again!";

$successText = "You successfully submitted the form and everything looks great! We'll get back to you soon; may the Force be with you!";
